\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.37]{images/reproducibility/wang/TDParse_F1_C_value_Dong.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.37]{images/reproducibility/wang/TDParse_F1_C_value_alt_scale_Dong.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.3]{images/reproducibility/Parameters/C_Value/C_Accuracy_Plot.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.3]{images/reproducibility/Parameters/C_Value/C_F1_Plot.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.3]{images/reproducibility/Parameters/Scaling/Scaling_Accuracy_Plot.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.3]{images/reproducibility/Parameters/Scaling/Scaling_F1_Plot.pdf}
...
\begin{figure}[!h]
    \centering
    \includegraphics[scale=0.3]{images/reproducibility/LSTM_Test_ACC.pdf}
